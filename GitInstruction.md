...
Ветки позволяют работать с черновиками и чистовиками документа.
...
**git branch -d branch_to_delete** -- удаляет указанную ветку

**git log --graph** -- визуализация всех веток с коммитами
